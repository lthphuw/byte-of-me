...
import { createEducation } from '@/lib/actions/dashboard/education/create-education';
import { deleteEducation } from '@/lib/actions/dashboard/education/delete-education';
import {
  EducationDetails,
  getEducations,
} from '@/lib/actions/dashboard/education/get-educations';
import { updateEducation } from '@/lib/actions/dashboard/education/update-education';
...
export function EducationManager({
  ...
  const [editing, setEditing] = useState<EducationDetails | null>(null);
  ...
  const saveMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        title: editing ? 'Education updated' : 'Education created',
      });
      setOpen(false);
    },
  ...
  const handleEdit = (edu: EducationDetails) => {
    setEditing(edu);
    setOpen(true);
  };
