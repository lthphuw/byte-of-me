...
export function ProjectDetailsContent({ readme, tocItems }: ProjectDetailsContentProps) {
    ...
    return (
        <>
            <div className="relative max-w-[100%] flex flex-col gap-4  md:gap-6 justify-center px-4 lg:px-8 py-12 max-w-full overflow-x-hidden">
                <Link href={'/projects'} className='flex items-center gap-3 px-0 justify-start'>
                    <Icons.arrowLeft />
                    <span>Back to projects</span>
                </Link>
                <article className="article-text prose dark:prose-invert max-w-full break-words overflow-x-hidden
