  ...
  return (
    <footer className={cn('py-8 relative z-20', className)}>
      <div className="container max-w-[100%] mx-auto px-4 md:px-12 flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        >
          <Link href="/about" className="text-sm md:text-base hover:text-blue-400">
            {t('about')}
          </Link>
          <Link href="/experience" className="text-sm md:text-base hover:text-blue-400">
            {t('experience')}
          </Link>
          <Link href="/projects" className="text-sm md:text-base hover:text-blue-400">
            {t('projects')}
          </Link>
          <Link href="/contact" className="text-sm md:text-base hover:text-blue-400">
            {t('contact')}
          </Link>
        </nav>
