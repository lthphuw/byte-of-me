 ...
 * file. Note what is no longer a reason: both surfaces live under `notes/`
 * now, so reuse would not cross a layer. The shape mismatch is the whole of
 * it. What the two surfaces genuinely share is the DEPARTURE
