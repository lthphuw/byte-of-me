 ...
 * inherits it for free. `#space-content` carries TOP itself, because that is
 * the one that actually reaches that edge; the rail handles its own bottom in
 ...
 * because it is the element whose background actually fills that space. A
 * page with no such bar (document-scrolling content, not a bar-anchored one)
 * is responsible for its own bottom padding, same as top/left/right already
 * were before this component existed.
 */
