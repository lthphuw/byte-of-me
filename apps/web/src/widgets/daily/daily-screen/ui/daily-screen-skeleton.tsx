...
/**
 * `DailyScreen`, loading, in the order the real screen renders. The calendar
 * is drawn with the real calendar's ANATOMY rather than as a generic block,
 * so nothing settles when the real grid arrives.
 */
        ...
        <div className="mx-auto flex w-full max-w-4xl flex-col gap-6 p-4 md:p-8">
          <div className="grid gap-6 lg:grid-cols-[minmax(0,3fr)_minmax(0,2fr)] lg:items-start lg:gap-8">
            <div className="flex min-w-0 flex-col gap-6">
              {/* The raster card: last night over fourteen rows. */}
