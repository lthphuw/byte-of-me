...
// Radix positions a context menu at the pointer, so `ContextMenu.Content` takes
// none of the anchor props `DropdownMenu.Content` does — there is no
// `sideOffset` to forward here.
