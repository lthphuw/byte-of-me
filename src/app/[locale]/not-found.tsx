                ...
                <div className="w-full">
                    <div className="flex flex-col gap-2 md:gap-4  items-stretch md:items-center max-w-lg mx-auto text-center">
                        ...
                        <div className="flex flex-col flex-wrap gap-4 mt-2 md:flex-row">
                            ...
                            <Link href="/">
                                <Button
                                    variant="secondary"
                                    className={cn("w-full gap-1 py-3 text-lg md:w-auto md:py-2 md:text-base shadow-md")}
                                >
                                    <span>{t("Home")}</span>
                                </Button>
                            </Link>
                    ...
                    <div className="grid w-full max-w-6xl grid-cols-1 gap-8 mx-auto mt-8 sm:grid-cols-2 lg:grid-cols-3">
                        {[
                            ...
                            <div key={href} className="p-6 rounded-lg gap-2 flex flex-col shadow-xl duration-300 transition-all dura hover:shadow-2xl bg-gray-100 dark:bg-gray-900">
                                {icon}
                                <h3 className="mt-4 font-medium text-md text-gray-700 dark:text-gray-200">{title}</h3>
