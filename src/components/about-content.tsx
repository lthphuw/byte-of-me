    ...
    return (
        <div className="relative flex justify-center px-4 lg:px-8 py-12">
            <div className="max-w-4xl w-full space-y-12">
                ...
                >
                    <h2 className="text-xl md:text-3xl font-bold mb-4">{sectionTitles.aboutMe}</h2>
                    <div
                ...
                <motion.section
                    ...
                    viewport={{ once: true, amount: 0.3 }}
                >
                    <Timeline title={sectionTitles.education} items={educationItems.map(item => ({
                        ...item,
                        message: <div dangerouslySetInnerHTML={{ __html: item.message as string }} />,
                        icon: item.icon,
                        subItems: item.subItems && item.subItems.map(sub => ({
                            title: sub.title,
                            message: <div dangerouslySetInnerHTML={{ __html: sub.message as string }} />,
                        })),
                    }))} />
                </motion.section>
                ...
                <motion.section
                    ...
                    viewport={{ once: true, amount: 0.3 }}
                >
                    <h2 className="text-xl md:text-3xl font-bold mb-4">{sectionTitles.skills}</h2>
