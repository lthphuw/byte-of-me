...
export const ExperimentalProvider: React.FC<ExperimentalProviderProps> = ({ children }) => {
    ...
    return (
        <ExperimentalContext.Provider value={{ isExperimentalMode, toggleExperimentalMode, throwRandomError }}>
            {children}
