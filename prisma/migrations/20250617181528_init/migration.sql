...
-- AddForeignKey
ALTER TABLE `experience_technologies` ADD CONSTRAINT `experience_technologies_experienceId_fkey` FOREIGN KEY (`experienceId`) REFERENCES `experiences`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `experience_technologies` ADD CONSTRAINT `experience_technologies_technologyId_fkey` FOREIGN KEY (`technologyId`) REFERENCES `technologies`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `translations` ADD CONSTRAINT `translations_technologyId_fkey` FOREIGN KEY (`technologyId`) REFERENCES `technologies`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
